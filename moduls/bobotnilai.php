...
?>
            <tr>
                ...
                <td class="text-center">
					...
					<a href="?page=hapusnilai&id=<?php echo $row['nuptk'] ?>" onclick="return confirm('Yakin ingin menghapus data')" class="btn btn-danger"><span class="glyphicon glyphicon-trash" aria-hidden="true"></span></a>
			    </td>
            </tr>
<?php
}
